defmodule QuenchWeb.UserLive.Registration do
  use QuenchWeb, :live_view

  alias Quench.Accounts
  alias Quench.Accounts.User
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: QuenchWeb.UserAuth.signed_in_path(socket))}
  end
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      socket
      |> assign(turnstile_site_key: Application.get_env(:quench, :turnstile, [])[:site_key])
